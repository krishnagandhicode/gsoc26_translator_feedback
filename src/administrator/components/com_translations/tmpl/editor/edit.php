...
<?php else : ?>
    ...
    <div class="mb-4">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="border rounded bg-body-tertiary px-3 py-2"><?php echo $sourceArticle->introtext; ?></div>
            </div>
            <div class="col-lg-6">
                <?php if ($hasTranslation) : ?>
    ...
    <div class="mb-4">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="border rounded bg-body-tertiary px-3 py-2"><?php echo $sourceArticle->fulltext; ?></div>
            </div>
            <div class="col-lg-6">
                <?php if ($hasTranslation) : ?>
